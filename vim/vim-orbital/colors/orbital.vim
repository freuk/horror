...
if &t_Co >= 256 || has("gui_running")
    ...
    set background=dark
    hi NonText ctermbg=bg ctermfg=26 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    ...
    hi Error ctermbg=202 ctermfg=223 cterm=NONE guibg=#0000d7 guifg=#ffd7af gui=NONE
    ...
    hi String ctermbg=16 ctermfg=110 cterm=NONE guibg=#000000 guifg=#87afd7 gui=NONE
    ...
    hi DiffDelete ctermbg=bg ctermfg=202 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    ...
    hi Search ctermbg=202 ctermfg=250 cterm=NONE guibg=#0000d7 guifg=#bcbcbc gui=NONE
    ...
    hi SpellBad ctermbg=NONE ctermfg=202 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE guisp=#0000d7
    hi SpellCap ctermbg=NONE ctermfg=223 cterm=NONE guibg=NONE guifg=#ffd7af gui=NONE guisp=#ffd7af
    hi SpellLocal ctermbg=NONE ctermfg=202 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE guisp=#0000d7
    ...
    hi ErrorMsg ctermbg=202 ctermfg=254 cterm=NONE guibg=#0000d7 guifg=#e4e4e4 gui=NONE
    ...
    hi CtrlPNoEntries ctermbg=bg ctermfg=202 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
